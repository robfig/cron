...
This section describes the specific format accepted by this cron.
...
All Cron are designed to be correctly synchronized as long as the caller ensures
that invocations have a clear happens-before ordering between them.
